...
CREATE TABLE IF NOT EXISTS `MV_TABLES_USED` (
  `MV_CREATION_METADATA_ID` bigint(20) NOT NULL,
  `TBL_ID` bigint(20) NOT NULL,
  PRIMARY KEY (`MV_CREATION_METADATA_ID`,`TBL_ID`),
...
CREATE TABLE TXN_COMPONENTS (
  TC_TXNID bigint NOT NULL PRIMARY KEY,
...
CREATE TABLE COMPLETED_TXN_COMPONENTS (
  CTC_TXNID bigint NOT NULL PRIMARY KEY,
...
CREATE TABLE NEXT_TXN_ID (
  NTXN_NEXT bigint NOT NULL PRIMARY KEY
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE NEXT_LOCK_ID (
  NL_NEXT bigint NOT NULL PRIMARY KEY
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE NEXT_COMPACTION_QUEUE_ID (
  NCQ_NEXT bigint NOT NULL PRIMARY KEY
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE WRITE_SET (
  ...
  PRIMARY KEY(WS_DATABASE, WS_TABLE, WS_PARTITION, WS_TXNID, WS_COMMIT_ID, WS_OPERATION_TYPE)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE TXN_TO_WRITE_ID (
  ...
  PRIMARY KEY(T2W_TXNID, T2W_DATABASE, T2W_TABLE, T2W_WRITEID)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE NEXT_WRITE_ID (
  ...
  PRIMARY KEY(NWI_DATABASE, NWI_TABLE, NWI_NEXT)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
